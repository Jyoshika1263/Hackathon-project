...
const Department = () => {
    return (
        ...
        <ul>
            <li className="cse">Faculty Details of CSE Department <a href ="http://localhost:3000/cse">CLICK HERE</a></li>
            <li className="it">Faculty Details of IT Department <a href ="http://localhost:3000/it">CLICK HERE</a></li>
            <li className="ece">Faculty Details of ECE Department <a href ="http://localhost:3000/ece">CLICK HERE</a></li>
            <li className="ai-ds">Faculty Details of AIDS Department <a href="http://localhost:3000/ai-ds">CLICK HERE</a></li>
